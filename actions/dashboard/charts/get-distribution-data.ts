...
export async function getDistributionData(
  ...
  try {
    ...
    const { type, dateRange, boardId, includeCompleted, companyId } = validatedInput;
      ...
      async () => {
        ...
        switch (type) {
          ...
          case "user":
            ...
            // Get user names WITH EXPLICIT COMPANY FILTERING
    ...
    return { success: false, error: "Failed to retrieve distribution data" };
  }
}
