...
): Promise<{ success: boolean; data?: TaskMetricsData; error?: string }> {
  try {
    ...
    const { dateRange, boardId, companyId } = validatedInput;
    ...
    return withCompanyAccessValidation(
      ...
      async () => {
        ...
        // Get all tasks count by status WITH EXPLICIT COMPANY FILTERING
        ...
        // Get tasks created this week WITH COMPANY FILTERING
        ...
        // Get tasks created this month WITH COMPANY FILTERING
        ...
        // Get overdue tasks WITH COMPANY FILTERING
        ...
        // Calculate average completion time WITH COMPANY FILTERING
        ...
        // Calculate trends WITH COMPANY FILTERING
    ...
    return { success: false, error: "Failed to retrieve task metrics" };
  }
}
