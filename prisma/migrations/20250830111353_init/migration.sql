...
-- CreateTable
CREATE TABLE "public"."AIGeneratedBoardRequest" (
    "id" TEXT NOT NULL,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
    ...
    "userId" TEXT NOT NULL,
    "companyId" TEXT NOT NULL,
    "generatedBoardId" TEXT,
    "failureReason" TEXT,

    CONSTRAINT "AIGeneratedBoardRequest_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "AIGeneratedBoardRequest_generatedBoardId_key" ON "public"."AIGeneratedBoardRequest"("generatedBoardId");
...
-- AddForeignKey
ALTER TABLE "public"."AIGeneratedBoardRequest" ADD CONSTRAINT "AIGeneratedBoardRequest_companyId_fkey" FOREIGN KEY ("companyId") REFERENCES "public"."companies"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."AIGeneratedBoardRequest" ADD CONSTRAINT "AIGeneratedBoardRequest_generatedBoardId_fkey" FOREIGN KEY ("generatedBoardId") REFERENCES "public"."Board"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."AIGeneratedBoardRequest" ADD CONSTRAINT "AIGeneratedBoardRequest_userId_fkey" FOREIGN KEY ("userId") REFERENCES "public"."users"("id") ON DELETE CASCADE ON UPDATE CASCADE;
