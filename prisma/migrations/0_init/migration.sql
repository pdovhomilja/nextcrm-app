...
-- CreateIndex
CREATE UNIQUE INDEX "task_embeddings_task_id_key" ON "public"."task_embeddings"("task_id");

-- CreateIndex
CREATE UNIQUE INDEX "board_embeddings_board_id_key" ON "public"."board_embeddings"("board_id");

-- CreateIndex
CREATE INDEX "ai_conversations_companyId_idx" ON "public"."ai_conversations"("companyId");
...
-- CreateIndex
CREATE INDEX "documents_taskId_idx" ON "public"."documents"("taskId");

-- CreateIndex
CREATE INDEX "documents_boardId_idx" ON "public"."documents"("boardId");

-- CreateIndex
CREATE UNIQUE INDEX "conversation_summaries_conversationId_key" ON "public"."conversation_summaries"("conversationId");
...
-- CreateIndex
CREATE INDEX "security_audit_logs_risk_idx" ON "public"."security_audit_logs"("risk");
...
-- AddForeignKey
ALTER TABLE "public"."Task" ADD CONSTRAINT "Task_assignedToId_fkey" FOREIGN KEY ("assignedToId") REFERENCES "public"."users"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."Task" ADD CONSTRAINT "Task_boardSectionId_fkey" FOREIGN KEY ("boardSectionId") REFERENCES "public"."BoardSection"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."Task" ADD CONSTRAINT "Task_createdById_fkey" FOREIGN KEY ("createdById") REFERENCES "public"."users"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "public"."BoardSection" ADD CONSTRAINT "BoardSection_boardId_fkey" FOREIGN KEY ("boardId") REFERENCES "public"."Board"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "public"."documents" ADD CONSTRAINT "documents_taskId_fkey" FOREIGN KEY ("taskId") REFERENCES "public"."Task"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."documents" ADD CONSTRAINT "documents_boardId_fkey" FOREIGN KEY ("boardId") REFERENCES "public"."Board"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."documents" ADD CONSTRAINT "documents_uploadedBy_fkey" FOREIGN KEY ("uploadedBy") REFERENCES "public"."users"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "public"."ai_generated_board_requests" ADD CONSTRAINT "ai_generated_board_requests_boardId_fkey" FOREIGN KEY ("boardId") REFERENCES "public"."Board"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."ai_generated_board_requests" ADD CONSTRAINT "ai_generated_board_requests_userId_fkey" FOREIGN KEY ("userId") REFERENCES "public"."users"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."ai_generated_board_requests" ADD CONSTRAINT "ai_generated_board_requests_companyId_fkey" FOREIGN KEY ("companyId") REFERENCES "public"."companies"("id") ON DELETE CASCADE ON UPDATE CASCADE;
