...
test.describe("Permissions - Accounts", () => {
  test("PE-R-001: user cannot restore account", async ({ userPage }) => {
...
test.describe("Permissions - Contacts", () => {
  test("PE-R-002: user cannot restore contact", async ({ userPage }) => {
    const permissions = new PermissionsPage(userPage);
...
test.describe("Permissions - Leads", () => {
  test("PE-R-003: user cannot restore lead", async ({ userPage }) => {
    const permissions = new PermissionsPage(userPage);
...
test.describe("Permissions - Contracts", () => {
  test("PE-R-004: user cannot restore contract", async ({ userPage }) => {
    const permissions = new PermissionsPage(userPage);
...
test.describe("Permissions - Products", () => {
  test("PE-R-005: user cannot delete products", async ({ userPage }) => {
    const permissions = new PermissionsPage(userPage);
...
test.describe("Permissions - Target Lists", () => {
  test("PE-R-006: user cannot delete target list", async ({ userPage }) => {
    const permissions = new PermissionsPage(userPage);
