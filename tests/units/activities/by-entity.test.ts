...
vi.mock("@/lib/prisma", () => ({
  prismadb: {
    ...
    crm_ActivityLinks: { findMany: vi.fn() },
    crm_Activities: { findMany: vi.fn() },
  },
}));
...
const gs = getSession as ReturnType<typeof vi.fn>;
const fu = prismadb.users.findUnique as ReturnType<typeof vi.fn>;
const fa = (prismadb as any).crm_Accounts.findFirst as ReturnType<typeof vi.fn>;
const linksFm = (prismadb as any).crm_ActivityLinks.findMany as ReturnType<typeof vi.fn>;
const actsFm = (prismadb as any).crm_Activities.findMany as ReturnType<typeof vi.fn>;
