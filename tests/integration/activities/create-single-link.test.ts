...
describe("create activity linked to a single entity", () => {
  ...
  it("persists the activity in crm_Activities with correct fields", {
    meta: {
      ...
      objective: "Validar que la acción de servidor persista la actividad de tipo nota vinculada a una única entidad en la base de datos",
      expectedStatus: "Actividad de tipo nota guardada con éxito",
      body: { type: "note", title: "PIACT-001 Test Note", description: "PIACT-001 Description", status: "completed", links: [{ entityType: "account", entityId: "ctx.account.id" }] },
  ...
  it("persists a single link in crm_ActivityLinks", {
    meta: {
      id: "PIACT-002",
      endpoint: "Server Action: createActivity",
      objective: "Validar que se registre correctamente la relación de la actividad con la entidad especificada en la tabla de enlaces",
