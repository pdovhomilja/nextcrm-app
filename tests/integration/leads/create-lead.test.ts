...
describe("create lead with valid data", () => {
  ...
  it("returns a data payload with the new lead id", {
    meta: {
      ...
      objective: "Verificar que la acción de servidor retorne un identificador válido al crear un lead con datos correctos",
      expectedStatus: "Identificador de lead generado",
      body: { first_name: "PILE-001", last_name: "Test Lead", email: "pile001@example.test", company: "PILE-001 Company" },
  ...
  it("writes an audit-log entry with action=created", {
    meta: {
      id: "PILE-003",
      endpoint: "Server Action: createLead",
      objective: "Validar que se registre una entrada en el registro de auditoría con la acción de creación correspondiente al lead",
