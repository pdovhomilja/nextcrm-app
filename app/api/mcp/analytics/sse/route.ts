            ...
            `event: connect\ndata: ${JSON.stringify({
              ...
              capabilities: {
                tools: {
                  ...
                  task_analytics: {
                    description:
                      "Generate task completion and performance analytics",
                  },
                  team_productivity: {
                    description:
                      "Analyze team productivity and workload distribution",
                  },
                  bottleneck_analysis: {
                  ...
                  progress_forecasting: {
                    description:
                      "Forecast project completion and milestone dates",
                  },
          ...
          content: [
            {
              ...
              text: JSON.stringify(
                {
                  message:
                    "Project health analysis - placeholder implementation",
                  status: "success",
          ...
          content: [
            {
              ...
              text: JSON.stringify(
                {
                  message:
                    "Team productivity analysis - placeholder implementation",
                  status: "success",
